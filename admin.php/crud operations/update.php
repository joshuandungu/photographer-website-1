...
if(isset($_POST['update'])) {
    if (!empty($_POST['id']) && !empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['mobile']) && !empty($_POST['password'])) {
        ...
        // $query = "insert into crud(id,name,email,mobile,password) values ('$id','$name','$email','$mobile','$password')";
        $query = "update `employee` set name='$name',email='$email',mobile='$mobile',password='$password' where id='$id'";
